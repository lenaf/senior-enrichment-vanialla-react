//this is the first thing node runs.  This is where we start the server
...
module.exports = app
  ...
  .use(bodyParser.json())
  .use(express.static(resolve(__dirname, '..', 'node_modules'))) // Serve static files from ../nodemodules
  .use(express.static(resolve(__dirname, '..', 'public'))) // Serve static files from ../public
  .use('/api', require('./api')) // Serve our api
  .get('/*', (_, res) => res.sendFile(resolve(__dirname, '..', 'public', 'index.html'))) // Send index.html for any other requests. Think about editing this to handle non-existent page requests
